...
public class Politics_fragment extends Fragment {

    View v;

    public Politics_fragment() {
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.politics_fragement, null);
        recyclerViewofpolitics = v.findViewById(R.id.politicsrecycler);
